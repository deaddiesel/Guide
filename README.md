...
## ⚙️ Setting up a Workspace / Compiling from Source
...
* 👤 **mezz** ([GitHub](https://github.com/mezz)) — For developing the Just Enough Items (JEI) API, which powers our in-game recipe integration.
* 👤 **vladsch** ([GitHub](https://github.com/vladsch)) — For the Flexmark-Java library, the robust Markdown parsing engine used inside our custom UI screens.
* 👥 **LexManos**, **cpw** & **Minecraft Forge Team** — For creating the FML loading ecosystem, MCP tools, and the excellent modding platform we build upon.
...
You are allowed to use this mod in your modpack. Any modpack which uses Guide takes **full** responsibility for user support queries. I only support official builds, not custom modified jars.

## 🔗 Quick Links

* 💻 **CurseForge** — Download official mod builds on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/guide)
* 💚 **Modrinth** — Check out modern updates on [Modrinth](https://modrinth.com/mod/guide-mod)
* 💬 **Discord** — Join our official community on [Discord](https://discord.com/invite/5dSRhHyjrs)
